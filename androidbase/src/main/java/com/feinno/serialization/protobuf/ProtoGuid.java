...
public class ProtoGuid {
	 ...
	 * @throws IOException
	 */
	public static Guid deserialize(com.feinno.serialization.protobuf.CodedInputStream input) throws IOException {
		Guid inner = new Guid();
	 ...
	 * @throws IOException
	 */
	public static void serialize(Guid value, com.feinno.serialization.protobuf.CodedOutputStream output,
