 ...
 * 描述： Android版本号类(拷贝自Android源码)，做版本兼容时用。（继承自 {@link android.os.Build.VERSION_CODES}）<br>
 *  
 * @version 1.0
 * @since JDK1.5
 */
public class AndroidVersionCodes extends android.os.Build.VERSION_CODES {
	 ...
	 * Service.onStartCommand} function will return the new {@link android.app.Service#START_STICKY} behavior instead of the
	 ...
	 * new changes in behavior:</p>
	 * <ul>
	 * <li> The default theme for applications is now dark holographic: {@link android.R.style#Theme_Holo}.
	 ...
	 * to the super implementation of its {@link android.app.Activity#onPause Activity.onPause()} method.
	 ...
	 * the preferences if they have changed on storage, unless {@link android.content.Context#MODE_MULTI_PROCESS} is used.
	 * <li> {@link android.view.ViewGroup#setMotionEventSplittingEnabled} will default to true.
	 * <li> {@link android.view.WindowManager.LayoutParams#FLAG_SPLIT_TOUCH} is enabled by default on windows.
	 * <li> {@link android.widget.PopupWindow#isSplitTouchEnabled()
	 * PopupWindow.isSplitTouchEnabled()} will return true by default.
	 * <li> {@link android.widget.GridView} and {@link android.widget.ListView} will use {@link android.view.View#setActivated View.setActivated} for selected items if they do not implement {@link android.widget.Checkable}.
	 ...
	 * support XLARGE screens will be assumed to do so only if they target {@link #HONEYCOMB} or later; it had been {@link #GINGERBREAD} or
	 ...
	 * based on the screen size in dp: see {@link android.content.res.Configuration#screenWidthDp}, {@link android.content.res.Configuration#screenHeightDp}, and {@link android.content.res.Configuration#smallestScreenWidthDp}.
	 * Supplying these in &lt;supports-screens&gt; as per {@link android.content.pm.ApplicationInfo#requiresSmallestWidthDp}, {@link android.content.pm.ApplicationInfo#compatibleWidthLimitDp}, and {@link android.content.pm.ApplicationInfo#largestWidthLimitDp} is
	 ...
	 * new changes in behavior:</p>
	 * <ul>
	 * <li><p>New {@link android.content.pm.PackageManager#FEATURE_SCREEN_PORTRAIT} and {@link android.content.pm.PackageManager#FEATURE_SCREEN_LANDSCAPE} features were introduced in this release. Applications that target
	 ...
	 * ActivityInfo.configChanges} will have the {@link android.content.pm.ActivityInfo#CONFIG_SCREEN_SIZE} and {@link android.content.pm.ActivityInfo#CONFIG_SMALLEST_SCREEN_SIZE} bits set; these need to be cleared for older applications because
	 ...
	 * You can use {@link android.R.attr#hardwareAccelerated android:hardwareAccelerated} to turn it off if needed, although this is strongly discouraged since
	 * it will result in poor performance on larger screen devices.
	 * <li> The default theme for applications is now the "device default" theme: {@link android.R.style#Theme_DeviceDefault}. This may be the
	 * holo dark theme or a different dark theme defined by the specific device.
	 * The {@link android.R.style#Theme_Holo} family must not be modified
	 * for a device to be considered compatible. Applications that explicitly
	 * request a theme from the Holo family will be guaranteed that these themes
	 * will not change character within the same platform version. Applications
	 * that wish to blend in with the device should use a theme from the {@link android.R.style#Theme_DeviceDefault} family.
	 ...
	 * <li> {@link android.content.Context#bindService Context.bindService()} will not automatically add in {@link android.content.Context#BIND_WAIVE_PRIORITY}.
	 ...
	 * new changes in behavior:</p>
	 * <ul>
	 * <li> You must explicitly request the {@link android.Manifest.permission#READ_CALL_LOG} and/or {@link android.Manifest.permission#WRITE_CALL_LOG} permissions;
	 * access to the call log is no longer implicitly provided through {@link android.Manifest.permission#READ_CONTACTS} and {@link android.Manifest.permission#WRITE_CONTACTS}.
	 * <li> {@link android.widget.RemoteViews} will throw an exception if
	 * setting an onClick handler for views being generated by a {@link android.widget.RemoteViewsService} for a collection container;
	 ...
	 * WebSettings.setAllowFileAccessFromFileURLs} and {@link android.webkit.WebSettings#setAllowUniversalAccessFromFileURLs(boolean)
	 ...
	 * NfcAdapter.setNdefPushMessage}, {@link android.nfc.NfcAdapter#setNdefPushMessageCallback
	 * NfcAdapter.setNdefPushMessageCallback} and {@link android.nfc.NfcAdapter#setOnNdefPushCompleteCallback
	 * NfcAdapter.setOnNdefPushCompleteCallback} will throw
	 * IllegalStateException if called after the Activity has been destroyed.
	 * <li> Accessibility services must require the new {@link android.Manifest.permission#BIND_ACCESSIBILITY_SERVICE} permission or
